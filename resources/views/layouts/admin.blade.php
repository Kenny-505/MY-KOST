            ...
            <div class="w-64 sidebar-bg shadow-xl flex flex-col">
                ...
                <nav class="flex-1 p-4 space-y-1">
                    ...
                    <a href="{{ route('admin.invoice.index') }}" 
                       class="flex items-center space-x-3 px-4 py-3 text-white rounded-lg hover:bg-white hover:bg-opacity-10 transition duration-200 {{ request()->routeIs('admin.invoice.*') ? 'sidebar-active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
